...
def plot(d__):
    ...
    nom_plot  = nom.copy();  nom_plot.view().value  = nom.values()  / widths;  nom_plot.view().variance  = nom.variances()  / widths**2
    up_plot   = up.copy();   up_plot.view().value   = up.values()   / widths;  up_plot.view().variance   = up.variances()   / widths**2
    down_plot = down.copy(); down_plot.view().value = down.values() / widths;  down_plot.view().variance = down.variances() / widths**2
