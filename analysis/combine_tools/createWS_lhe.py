#!/usr/bin/env python3
"""
createWS_lhe.py — build text2workspace for the LHE (old) pipeline.
Uses AnomalousCouplingEFTNegative_comb (quad_ / sm_lin_quad_ process names).
For the RECO morphing pipeline use createWS.py instead.
"""
