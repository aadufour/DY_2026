#!/usr/bin/env python3
"""
build_datacard_reco_bins.py

Identical to build_datacard_syst.py but uses the RECO mll binning (34 bins,
50-3000 GeV) instead of the coarse 7-bin LHE binning. Use this to produce
LHE-level datacards with the same binning as the spritz RECO analysis, so
that likelihood scan constraints are directly comparable.
...
Usage:
    python3 build_datacard_reco_bins.py --op cHDD --pdf-flavour 5 --lumi 59740
    python3 build_datacard_reco_bins.py --all_op --lumi 59740 --pdf-flavour 5
"""
...
#   50-75:   5 GeV steps
#   76-105:  2 GeV steps (Z peak)
#   106-119: 5 GeV steps
#   120+:    coarser steps up to 3000
MLL_EDGES = np.array([
