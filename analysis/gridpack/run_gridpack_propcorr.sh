#!/bin/bash
# run_gridpack_propcorr.sh
# Production event generation from propagator-corrected gridpacks.
...
GRIDPACK_DIR="${GRID_BASE}/gridpacks/propcorr/DYSMEFTMll${BIN}_propcorr"
OUTPUT_DIR="${GRID_BASE}/LHE/propcorr/DYSMEFTMll${BIN}_propcorr"
