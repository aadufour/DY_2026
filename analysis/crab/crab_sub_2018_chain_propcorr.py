...
gp_path = "/eos/user/a/aldufour/gridpacks/DYSMEFTMll{}_propcorr_slc7_amd64_gcc700_CMSSW_10_6_19_tarball.tar.xz".format(mll_bin.split("mll_")[1])

events_per_job = 500
PROD = 'DYSMEFTMll-nanoaod18_SMEFTsim_propcorr_' + mll_bin
...
config.Data.outLFNDirBase = '/store/user/aldufour/3DY_SMEFTsim_LO_propcorr/'
