...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:SMP-RunIISummer20UL18DIGIPremix-00035.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('--eventcontent nevts:193'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SMP-RunIISummer20UL18HLT-00035.root'),
