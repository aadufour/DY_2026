...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:SMP-RunIISummer20UL18wmLHEGEN-00061.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('--eventcontent nevts:419'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SMP-RunIISummer20UL18SIM-00035.root'),
