# ruff: noqa: E501
"""
config_same_bins.py  —  config_triple_diff + consistent mll binning
=====================================================================
Same as config_triple_diff, but the 1D mll variable uses the same coarse
binning as the mll dimension in triple_diff:
  mll: [40,60,80,100,120,140,180,220,270,350,500] GeV  (10 bins)

This makes the mll and triple_diff observables directly comparable in combine.
...
# ---- Variables ---------------------------------------------------------------
# Coarse mll binning — matches the mll axis inside triple_diff (10 bins, 40–500 GeV)
mll_bins = [40, 60, 80, 100, 120, 140, 180, 220, 270, 350, 500]
