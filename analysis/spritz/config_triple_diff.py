# ruff: noqa: E501
"""
config_triple_diff.py  —  config_syst_full + triple-differential variable
==========================================================================
Adds a triple-differential (mll × cosθ* × |y_ll|) unrolled histogram on top of
config_syst_full. The runner fills it as a 3D histogram; spritz-postproc unrolls
it to 1D (10 × 5 × 4 = 200 bins) for combine.

Triple-diff binning (Fabian's, from config_fabian_test.py):
  mll:          [40,60,80,100,120,140,180,220,270,350,500] GeV  (10 bins, up to 500 GeV)
  costhetastar: [-1.0,-0.6,-0.2,0.2,0.6,1.0]                  (5 bins)
  rapll_abs:    [0.0,0.48,0.96,1.44,2.4]                       (4 bins, within eta<2.4)

Also adds mll < 500 GeV cut to inc_mm_ss (SS control region only — signal region
inc_mm keeps the full mll range for EFT sensitivity).
